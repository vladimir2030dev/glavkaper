	...
	array(
		...
		'fields'     => array(
			...
			array(
				...
				'subtitle'          => esc_html__( 'You decide.', 'your-textdomain-here' ),
				'desc'              => wp_kses( __( 'Enter <code>1</code> and click <strong>Сохранить</strong> for an error message, or enter <code>2</code> and click <strong>Сохранить</strong> for a warning message.', 'your-textdomain-here' ), $kses_exceptions ),
