<?php
/**
 * Template for WP Slick Slider and Image Carousel Pro - prodesign-33
 *
 * This template can be overridden by copying it to yourtheme/wp-slick-slider-and-image-carousel-pro/variable-width/prodesign-33.php
 *
		...
		<div class="wpsisac-slider-content">
			...
			<div class="wpsisac-short-content">
				<h2 class="wpsisac-slide-title">
					<a href="<?php echo esc_url($read_more_url); ?>" target="<?php echo $link_target; ?>"><?php echo $slick_post_title; ?></a>
				</h2>
			</div>
			<?php } 
			if($show_content) { ?>
