 ...
 *
 * This template can be overridden by copying it to yourtheme/wp-slick-slider-and-image-carousel-pro/carousel/prodesign-18.php
 *
	...
	<div class="wpsisac-slide-wrap">
		...
		<div class="wpsisac-slider-content">
			<div class="wpsisac-show-hide-content">
				...
				<?php } 
				if($show_content ) { ?>
					<div class="wpsisac-slider-short-content"><?php the_content(); ?>
					</div>
				<?php }
