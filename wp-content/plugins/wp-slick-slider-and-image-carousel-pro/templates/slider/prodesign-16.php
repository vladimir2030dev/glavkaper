 ...
 *
 * This template can be overridden by copying it to yourtheme/wp-slick-slider-and-image-carousel-pro/slider/prodesign-16.php
 *
		...
		<div class="wpsisac-slider-content">
			...
			<?php if(($show_content && !empty(get_the_content())) || (!empty($read_more_url) && $show_read_more) ) { ?>
				<div class="wpsisac-slider-short-content">
					<?php if($show_content && get_the_content() ) { ?>
						<?php the_content(); ?>
					<?php } ?>
