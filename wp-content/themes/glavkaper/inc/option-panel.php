...
$args = array(
	...
	'menu_title'                => esc_html__( 'Глобальные настройки', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Глобальные настройки', 'your-textdomain-here' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Глобальные настройки', 'your-textdomain-here' ),
		'id'               => 'basic',
		'desc'             => esc_html__( 'Основные настройки сайта', 'your-textdomain-here' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Раздел о нас', 'your-textdomain-here' ),
		'id'               => 'editor',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Логотип сайта', 'your-textdomain-here' ),
		'id'    => 'media',
		'icon'  => 'el el-picture',
	)
);
